...
describe('Banner component', () => {
  it('renders correctly', () => {
    ...
    expect(screen.getByText('ASPA - Auckland Student Pool Association')).toBeInTheDocument();
    expect(screen.getByText('ASPA Home: View ASPA Landing Page')).toBeInTheDocument();
  });
});