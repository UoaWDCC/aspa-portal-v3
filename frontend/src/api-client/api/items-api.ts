...
export const ItemsApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    createItemsExecutive: async (
      meta?: string,
      createItemsExecutiveRequest?: CreateItemsExecutiveRequest,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    deleteSingleItemsExecutive: async (
      id: ReadSingleItemsEventIdParameter,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("deleteSingleItemsExecutive", "id", id);
      const localVarPath = `/items/Executive/{id}`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    readSingleItemsExecutive: async (
      id: ReadSingleItemsEventIdParameter,
      fields?: Array<string>,
      meta?: string,
      version?: string,
     ...
     * @throws {RequiredError}
     */
    updateSingleItemsExecutive: async (
      id: ReadSingleItemsEventIdParameter,
      fields?: Array<string>,
      meta?: string,
      itemsExecutive?: ItemsExecutive,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
  ...
  return {
    ...
    > {
      ...
      const localVarOperationServerBasePath =
        operationServerMap["ItemsApi.createItemsEvent"]?.[
    ...
    async createItemsExecutive(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<CreateItemsExecutive200Response>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createItemsExecutive(
          meta,
          createItemsExecutiveRequest,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ItemsApi.createItemsExecutive"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ItemsApi.deleteItemsEvent"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async deleteItemsExecutive(
      options?: RawAxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.deleteItemsExecutive(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ItemsApi.deleteItemsExecutive"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ItemsApi.deleteSingleItemsEvent"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async deleteSingleItemsExecutive(
      id: ReadSingleItemsEventIdParameter,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.deleteSingleItemsExecutive(id, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ItemsApi.deleteSingleItemsExecutive"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ItemsApi.readItemsEvent"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async readItemsExecutive(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<ReadItemsExecutive200Response>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.readItemsExecutive(
          fields,
          limit,
          meta,
          offset,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ItemsApi.readItemsExecutive"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ItemsApi.readSingleItemsEvent"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async readSingleItemsExecutive(
      id: ReadSingleItemsEventIdParameter,
      fields?: Array<string>,
      meta?: string,
      version?: string,
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<ReadSingleItemsExecutive200Response>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.readSingleItemsExecutive(
          id,
          fields,
          meta,
          version,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ItemsApi.readSingleItemsExecutive"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ItemsApi.updateItemsEvent"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async updateItemsExecutive(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<UpdateItemsExecutive200Response>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.updateItemsExecutive(
          fields,
          limit,
          meta,
          offset,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ItemsApi.updateItemsExecutive"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ItemsApi.updateSingleItemsEvent"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async updateSingleItemsExecutive(
      id: ReadSingleItemsEventIdParameter,
      fields?: Array<string>,
      meta?: string,
      itemsExecutive?: ItemsExecutive,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.updateSingleItemsExecutive(
          id,
          fields,
          meta,
          itemsExecutive,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ItemsApi.updateSingleItemsExecutive"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const ItemsApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    createItemsExecutive(
      meta?: string,
      createItemsExecutiveRequest?: CreateItemsExecutiveRequest,
      options?: any,
    ): AxiosPromise<CreateItemsExecutive200Response> {
      return localVarFp
        .createItemsExecutive(meta, createItemsExecutiveRequest, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Delete multiple existing Event items.
     ...
     * @throws {RequiredError}
     */
    deleteSingleItemsExecutive(
      id: ReadSingleItemsEventIdParameter,
      options?: any,
    ): AxiosPromise<void> {
      return localVarFp
        .deleteSingleItemsExecutive(id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * List the Event items.
    ...
    readSingleItemsExecutive(
      ...
      return localVarFp
        .readSingleItemsExecutive(id, fields, meta, version, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Update multiple Event items at the same time.
    ...
    updateSingleItemsExecutive(
      ...
      return localVarFp
        .updateSingleItemsExecutive(id, fields, meta, itemsExecutive, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class ItemsApi extends BaseAPI {
   ...
   * @memberof ItemsApi
   */
  public deleteSingleItemsExecutive(
    id: ReadSingleItemsEventIdParameter,
    options?: RawAxiosRequestConfig,
  ) {
    return ItemsApiFp(this.configuration)
   ...
   * @memberof ItemsApi
   */
  public readSingleItemsExecutive(
    id: ReadSingleItemsEventIdParameter,
    fields?: Array<string>,
    meta?: string,
    version?: string,
   ...
   * @memberof ItemsApi
   */
  public updateSingleItemsExecutive(
    id: ReadSingleItemsEventIdParameter,
    fields?: Array<string>,
    meta?: string,
    itemsExecutive?: ItemsExecutive,
