 ...
 * @export
 */
export const ItemsExecutiveApiAxiosParamCreator = function (
...
export const ItemsExecutiveApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    ItemsExecutiveApiAxiosParamCreator(configuration);
  return {
    /**
     * Create a new Executive item.
     * @summary Create an Item
    ...
    > {
      ...
      const localVarOperationServerBasePath =
        operationServerMap["ItemsExecutiveApi.createItemsExecutive"]?.[
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ItemsExecutiveApi.deleteItemsExecutive"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ItemsExecutiveApi.deleteSingleItemsExecutive"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ItemsExecutiveApi.readItemsExecutive"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ItemsExecutiveApi.readSingleItemsExecutive"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ItemsExecutiveApi.updateItemsExecutive"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ItemsExecutiveApi.updateSingleItemsExecutive"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
 ...
 * @export
 */
export const ItemsExecutiveApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
...
export class ItemsExecutiveApi extends BaseAPI {
  ...
  public createItemsExecutive(
    ...
    return ItemsExecutiveApiFp(this.configuration)
      .createItemsExecutive(meta, createItemsExecutiveRequest, options)
