...
export const FieldsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createField(collection: string, createFieldRequest?: CreateFieldRequest, options?: any): AxiosPromise<CreateField200Response> {
         ...
         * @throws {RequiredError}
         */
        deleteField(collection: string, id: string, options?: any): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        getCollectionField(collection: string, id: string, options?: any): AxiosPromise<CreateField200Response> {
         ...
         * @throws {RequiredError}
         */
        updateField(collection: string, id: string, updateFieldRequest?: UpdateFieldRequest, options?: any): AxiosPromise<CreateField200Response> {
