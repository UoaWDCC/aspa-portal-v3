  ...
  return {
    ...
    async createCollection(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<CreateCollection200Response>
    > {
      ...
      const localVarOperationServerBasePath =
        operationServerMap["CollectionsApi.createCollection"]?.[
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["CollectionsApi.deleteCollection"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["CollectionsApi.getCollection"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async getCollections(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<GetCollections200Response>
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["CollectionsApi.getCollections"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["CollectionsApi.updateCollection"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const CollectionsApiFactory = function (
  ...
  return {
    ...
    createCollection(
      ...
      return localVarFp
        .createCollection(meta, createCollectionRequest, options)
    ...
    updateCollection(
      ...
      return localVarFp
        .updateCollection(id, meta, updateCollectionRequest, options)
        .then((request) => request(axios, basePath));
    },
  };
};
