...
describe('PhotoRow component', () => {
  ...
  it('renders all photos', () => {
    render(<PhotoRow photoListChunk={samplePhotos} style={false} onImageClick={onImageClick} />);
  ...
  it('applies correct background when style is true', () => {
    render(<PhotoRow photoListChunk={samplePhotos} style={true} onImageClick={onImageClick} />);
  ...
  it('renders empty grid when no photos provided', () => {
    render(<PhotoRow photoListChunk={[]} style={false} onImageClick={onImageClick} />);
