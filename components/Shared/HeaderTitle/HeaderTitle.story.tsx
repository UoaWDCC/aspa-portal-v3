...
const meta: Meta<typeof HeaderTitle> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'An animated title component with floating animation and layered text shadow effects.',
      },
    },
  },
  tags: ['autodocs'],
...
export const WithCustomClass: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Example showing how to apply custom CSS classes to the component.',
      },
    },
  },
};
...
export const Playground: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Interactive playground - edit the text and shadow layers to see how it looks with different content.',
      },
    },
  },
};