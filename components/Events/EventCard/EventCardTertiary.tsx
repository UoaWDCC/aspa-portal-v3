...
export function EventCardTertiary({ events, bg_color=rgba('#717882', 1), font_color=rgba('#FFFFFF', 1), max_height=250, min_height=200} : EventCardTertiaryProps) {
    ...
    return (
        ...
        >
            ...
            {/* <Flex direction="column" ml="md" justify="space-between" gap="lg" style={{ flex: 1 }}></Flex>*/}
