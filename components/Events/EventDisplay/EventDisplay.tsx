  ...
  let eventIdx = 0;
    ...
    return (
        <Stack align="center" gap={gap}>
            <Text fz={title_fs} fw={title_fw} mb="md" c={font_color}>{title}</Text>
            ...
            {displayTypes.map((type: displayType,) => {
                switch(type) {
                    case displayType.Main:
                        ...
                        eventIdx += 1;
                        return (
                            <EventCardMain {...mainProps} event={mainEvent}/>
                        );
                    ...
                    case displayType.Secondary: 
                        ...
                        eventIdx += 2;
                        return (
                            <EventCardSecondary {...secondaryProps} events={secondaryEvents}/>
                        );
