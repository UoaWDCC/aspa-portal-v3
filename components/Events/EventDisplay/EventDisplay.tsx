            ...
            {displayTypes.map((type: displayType,) => {
                switch(type) {
                    case displayType.Main:
                        ...
                        eventIdx += 1;
                        return (
                            <EventCardMain event={mainEvent} bg_color={bg_color} font_color={font_color} max_height={main_max_h} min_height={main_min_h} />
                        );
                    ...
                    case displayType.Secondary: 
                        ...
                        eventIdx += 2;
                        return (
                            <EventCardSecondary events={secondaryEvents} bg_color={bg_color} font_color={font_color} max_height={second_max_h} min_height={second_min_h} />
                        );
                    ...
                    case displayType.Tertiary:
                        ...
                        eventIdx += 2;
                        return (
                            <EventCardTertiary events={tertiaryEvents} bg_color={bg_color} font_color={font_color} max_height={second_max_h} min_height={second_min_h} />
                        );
